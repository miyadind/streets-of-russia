const GAME_CONFIG = {
  ...
  heroes: {
    alexey: {
      ...
      ability: 'Один раз за прохождение может вернуться в бой после нокаута с частью здоровья. Хороший выбор для первого прохождения.'
    },
    anna: {
      name: 'Анна',
      role: 'fast',
      ...
      ability: 'Самая высокая скорость передвижения. Может быстрее выходить из окружения и лучше подходит для тактики ударил — ушёл.'
    },
    boris: {
      name: 'Борис',
      role: 'tank',
      ...
      ability: 'Повышенный урон и самый большой запас здоровья. Лучше всего подходит для прямой драки против сильных врагов.'
    }
  },
