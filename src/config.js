const GAME_CONFIG = {
  ...
  heroes: {
    alexey: { name: 'Алексей', role: 'balanced', hp: 120, speed: 2.6, damage: 16, scale: 0.165, strength: 5, speedStat: 5, health: 5, color: '#4f9cff' },
    anna: { name: 'Анна', role: 'fast', hp: 85, speed: 3.15, damage: 12, scale: 0.11, strength: 3, speedStat: 7, health: 4, color: '#c163ff' },
    boris: { name: 'Борис', role: 'tank', hp: 160, speed: 2.25, damage: 22, scale: 0.16, strength: 7, speedStat: 3, health: 8, color: '#5fd65f' }
  },
